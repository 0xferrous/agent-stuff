...
| [`agent-summary.ts`](extensions/agent-summary.ts) | Shows a TUI-only summary of consulted (read) and changed (write/edit) files after each turn without adding it to LLM context |
